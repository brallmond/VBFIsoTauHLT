...
parser.add_option("-v","--validation",action="store_false", dest="verbose", default=False,help="use the validation")
...
physics_path = {
                "di-tau":[
                           ...
                           ["L2TrigTauEtEff","L2TrigTauHighEtEff","L3TrigTauHighEtEff"],
                ...
                "VBF-tau-lower-leg":[
                            "HLT_IsoMu24_eta2p1_MediumDeepTauIsoPFTauHPS20_eta2p1_SingleL1",
                            ["L2TrigTauEtEff","L2TrigTauHighEtEff","L3TrigMuonEtEff","L3TrigTauHighEtEff"]
                         ]
                }
