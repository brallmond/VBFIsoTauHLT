void CutflowDeepTauTempLooseNoL2NN(char* filename) {
  ...
  double doubleDeep20TausFilter = tree->Draw("nEvents", "passhltHpsDoublePFTau20TempLooseDitauWPDeepTauNoMatch_VBF2DTTempLooseNoL2NN>0 && passVBFPlusTwoTauOff>0", "goff");
  double singleDeep45TauL1HLTMatchingFilter = tree->Draw("nEvents", "passhltHpsSinglePFTau45TempLooseDitauWPDeepTauL1HLTMatched_VBF2DTTempLooseNoL2NN>0 && passVBFPlusTwoTauOff>0", "goff");
  double jetKinemFilter = tree->Draw("nEvents", "passhltRealDijetFilter_VBF2DTTempLooseNoL2NN>0 && passVBFPlusTwoTauOff>0", "goff");
  double jetIDFilter = tree->Draw("nEvents", "passhltVBFLooseIDPFDummyFilter_VBF2DTTempLooseNoL2NN>0 && passVBFPlusTwoTauOff>0", "goff");
  double twoMatchedJetsFilter = tree->Draw("nEvents", "passhltMatchedVBFIsoTauTwoPFJets2CrossCleanedFromDoubleHpsTempLooseDeepTauIsoPFTauHPS20_VBF2DTTempLooseNoL2NN>0 && passVBFPlusTwoTauOff>0", "goff");

  double hltVBFTwoDeepTauDecision = tree->Draw("nEvents", "passVBF2DTTempLooseNoL2NNHLT>0 && passVBFPlusTwoTauOff>0","goff");
  double passSelectionOnly = tree->Draw("nEvents", "passVBFPlusTwoTauOff>0", "goff");
  double passSelectionToo = tree->Draw("nEvents", "passVBF2DTTempLooseNoL2NNBoth>0", "goff");
