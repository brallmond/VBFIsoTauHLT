...
//    TCut misst2pt = "t1_ptAOD>=25 && t2_ptAOD>= 0 && j1_ptAOD>=120 && j2_ptAOD>=45 && mjjAOD>=700";
//    TCut missj1pt = "t1_ptAOD>=25 && t2_ptAOD>=25 && j1_ptAOD>= 0 && j2_ptAOD>=45 && mjjAOD>=700";
//    TCut missj2pt = "t1_ptAOD>=25 && t2_ptAOD>=25 && j1_ptAOD>=120 && j2_ptAOD>= 0 && mjjAOD>=700";
//    TCut missMjj  = "t1_ptAOD>=25 && t2_ptAOD>=25 && j1_ptAOD>=120 && j2_ptAOD>=45 && mjjAOD>=  0";
//
    TCut misst1pt = "t1_ptAOD>= 0 && t2_ptAOD>=60 && j1_ptAOD>=150 && j2_ptAOD>=70 && mjjAOD>=1000";
    TCut misst2pt = "t1_ptAOD>=60 && t2_ptAOD>= 0 && j1_ptAOD>=150 && j2_ptAOD>=70 && mjjAOD>=1000";
    TCut missj1pt = "t1_ptAOD>=60 && t2_ptAOD>=60 && j1_ptAOD>= 0 && j2_ptAOD>=70 && mjjAOD>=1000";
    TCut missj2pt = "t1_ptAOD>=60 && t2_ptAOD>=60 && j1_ptAOD>=150 && j2_ptAOD>= 0 && mjjAOD>=1000";
    TCut missMjj  = "t1_ptAOD>=60 && t2_ptAOD>=60 && j1_ptAOD>=150 && j2_ptAOD>=70 && mjjAOD>=  0";

    
    TCut missjets = "t1_ptAOD>=25 && t2_ptAOD>=25 && j1_ptAOD>= 0 && j2_ptAOD>= 0 && mjjAOD>=700"; // lets us get a better look at j1_pt
