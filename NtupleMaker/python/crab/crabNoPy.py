...
config.JobType.psetName = 'hltPre6Eff.py'
...
config.JobType.inputFiles = ['L1Menu_Collisions2022_v0_1_6.xml']
...
config.General.requestName = 'VBF_Pre6Eff_CorrectedHLTOvRmvl_retry2'
