...
config.JobType.psetName = 'hltPre6EZBRate.py'
...
config.JobType.inputFiles = ['L1Menu_Collisions2022_v0_1_6.xml','forceNewJEC.py']
...
config.General.requestName = 'Pre6Rate_EZB8'
