...
config.JobType.psetName = 'hltRateGRun66.py'
...
config.JobType.inputFiles = ['L1Menu_Collisions2022_v1_0_0.xml','forceNewJEC.py']
...
config.General.requestName = 'RateGRun66_EZB8'
